  ...
  <div id="poster"style="background: #8edcaa">
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button type="primary" style="background:#3fb280;border:none" @click="submitForm(ruleForm)">注册</el-button>
...
export default {
  ...
  methods: {
    submitForm(ruleForm) {
      ...
      this.axios.post('/api/user/register',this.ruleForm).then((resp)=>{
        console.log(resp);
        let data = resp.data;
        console.log(data);
        if(data.success){
